export declare type LinkedStoreValues = boolean | number | string | Map<string, LinkedStoreValues>;
...
export declare class LinkedStore {
    ...
    setTerm(term: string, value: boolean | number | string | Map<string, LinkedStoreValues>): void;
